...
![Generation des nodes](../assets/GIF/Nodes.gif)
...
![ZombieClassique](../assets/GIF/ZombieClassique.gif)
...
![State IDLE](../assets/GIF/StateMachineIDLEZombieClassique.PNG)
...
![State FOLLOW](../assets/GIF/StateMachineFOLLOWZombieClassique2.PNG)
...
![State RETURN_INITIALPOSITION](../assets/GIF/StateMachineRETURN_INITIALPOSITIONZombieClassique.PNG)
...
![State ATTACK](../assets/GIF/StateMachineATTACKZombieClassique.PNG)
...
![Condition de mort](../assets/GIF/DépartUpdateForStateMachineZombieClassique.PNG)

Si il entre en état DEAD il va alors jouer son animation de mort puis se détruire.

![State DEAD](../assets/GIF/StateMachineDEADZombieClassique.PNG)
...
![State ATTACK](../assets/GIF/StateMachineATTACKZombieKamikaze.PNG)
